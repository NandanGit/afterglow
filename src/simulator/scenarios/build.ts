      ...
      events: [
        {
          type: "output",
          delay: 500,
          tokens: [{ text: "> webapp@1.0.0 lint", class: "ansi-bright-black" }],
        },
        {
          type: "output",
          delay: 300,
        ...
        { type: "output", delay: 800, text: "" },
        {
          type: "output",
          delay: 200,
          tokens: [{ text: "src/utils/format.ts", class: "ansi-cyan" }],
        },
        {
          type: "output",
          delay: 100,
          tokens: [
            ...
            {
              text: "  @typescript-eslint/no-explicit-any",
              class: "ansi-bright-black",
            },
          ],
        },
        {
          ...
          tokens: [
            ...
            {
              text: "  @typescript-eslint/no-unused-vars",
              class: "ansi-bright-black",
            },
          ],
        },
        { type: "output", delay: 200, text: "" },
        {
          ...
          tokens: [
            {
              text: "✖ 2 problems (0 errors, 2 warnings)",
              class: "ansi-yellow",
            },
          ],
        },
    ...
    },
    {
      ...
      events: [
        ...
        },
        {
          type: "output",
          delay: 200,
          tokens: [{ text: "> tsc && vite build", class: "ansi-bright-black" }],
        },
        {
          type: "output",
          delay: 1200,
