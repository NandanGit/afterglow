  ...
  commands: [
    {
      ...
      events: [
        { type: 'output', delay: 400, tokens: [
          { text: 'Python 3.12.1 (main, Dec 15 2025)', class: '' },
        ]},
        { type: 'output', delay: 100, tokens: [
          { text: 'Type "help", "copyright" for more information.', class: 'ansi-bright-black' },
        ]},
      ],
    },
    {
    ...
    },
    {
      ...
      events: [
        { type: 'output', delay: 300, tokens: [
          { text: '2.718281828459045', class: 'ansi-cyan' },
        ]},
      ],
    },
    {
      ...
      events: [
        ...
        { type: 'output', delay: 150, tokens: [
          { text: '  File "<stdin>", line 1, in <module>', class: '' },
        ]},
        { type: 'output', delay: 150, tokens: [
          { text: 'AttributeError', class: 'ansi-bright-red' },
          { text: ': \'NoneType\' object has no attribute \'append\'', class: 'ansi-red' },
        ]},
      ],
    },
  ],
